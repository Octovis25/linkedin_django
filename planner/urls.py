...
urlpatterns = [
    ...
    path('api/nc-videos/', views.api_nc_videos, name='api_nc_videos'),
    path('api/studio-outputs/', views.api_studio_outputs, name='api_studio_outputs'),
    path('api/studio-images/', views.api_studio_images, name='api_studio_images'),
    path('nc-video-preview/<str:filename>/', views.nc_video_preview, name='nc_video_preview'),
