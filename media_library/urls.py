...
urlpatterns = [
    ...
    # Upload (Studio_Work/Upload)
    path('studio/upload/',                   views.studio_upload,               name='studio_upload'),
    path('studio/upload/delete/',            views.studio_upload_delete,        name='studio_upload_delete'),
